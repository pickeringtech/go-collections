...
This report is regenerated and committed on every push to `main`. It is the full companion to the headline preview in the [README](README.md#performance).

## Provenance

- **Commit:** `0b87bdf`
- **Generated (UTC):** 2026-06-16T18:47:39Z
- **Go:** go1.25.5
- **Runner:** linux/amd64
...
> ⚠️ GitHub-hosted runners are shared and noisy, so these numbers are **indicative, not authoritative**. Trust them for orders of magnitude and relative comparisons between implementations — not as precise absolute timings.
