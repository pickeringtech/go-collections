...
func NewDict[K comparable, V any]() dicts.Dict[K, V] {
	return dicts.NewHash[K, V]()
}

func NewConcurrentDict[K comparable, V any]() dicts.Dict[K, V] {
	return dicts.NewHash[K, V]()
}

func NewConcurrentRWDict[K comparable, V any]() dicts.Dict[K, V] {
	return dicts.NewHash[K, V]()
}
