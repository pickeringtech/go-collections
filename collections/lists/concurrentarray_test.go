...
func TestConcurrentArray_Insert(t *testing.T) {
	...
	tests := []testCase[int]{
		...
		{
			name: "inserting into empty ConcurrentArray yields the elements",
			a:    lists.NewConcurrentArray[int](),
			args: args[int]{
				index:    0,
				elements: []int{6, 7, 8},
		...
		},
		{
			...
			a:    lists.NewConcurrentArray[int](1, 2, 3),
			args: args[int]{
				index:    5,
				elements: []int{6, 7, 8},
			},
		...
		{
			name: "out-of-range index on empty ConcurrentArray yields non-nil empty output",
			a:    lists.NewConcurrentArray[int](),
			args: args[int]{
				index:    2,
				elements: []int{6, 7, 8},
...
func TestConcurrentArray_Pop(t *testing.T) {
	...
	tests := []testCase[int]{
		...
		{
			name:    "empty ConcurrentArray yields zero value output and empty (non-nil) slice",
			a:       lists.NewConcurrentArray[int](),
			want:    0,
			wantOK:  false,
			wantSli: []int{},
