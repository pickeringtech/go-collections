...
- **Keep cleanups separable.** Put unrelated tidy-ups in their own commit (e.g. `refactor:` / `docs:`) so the feature/fix diff stays readable and revertible. Never bury a behaviour change inside a "cleanup."
